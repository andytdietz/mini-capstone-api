...
Product.create!([
  { name: "Shark Vacuum", price: "200.0", description: "A vacuum that is bloodthirsty", inventory: nil, supplier_id: 2 },
  { name: "Silonn Ice Maker", price: "89.0", description: "Fast ice maker!", inventory: nil, supplier_id: 1 },
  { name: "8 Inch Tortilla Press", price: "12.0", description: "Make your own homemade tortillas with this cast aluminum tortilla press!", inventory: nil, supplier_id: 1 },
  ...
  { name: "The Rock Blanket", price: "20.0", description: "A very fluffy blanket with Dwayne The Rock Johnson's face on it. Adding more to make this longer", inventory: nil, supplier_id: 1 },
  { name: "cat toy", price: "4.0", description: "toy for your cat. your cat will absolultely love this toy, or maybe not.", inventory: nil, supplier_id: 1 },
])
Image.create!([
