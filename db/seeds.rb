...
Product.create!([
  ...
  { name: "Silonn Ice Maker", price: "89.00", description: "Fast ice maker!", inventory: 1, supplier_id: 1 },
  { name: "8 Inch Tortilla Press", price: "12.00", description: "Make your own homemade tortillas with this cast aluminum tortilla press!", inventory: 4, supplier_id: 1 },
  { name: "Computer Monitor", price: "150.0", description: "24 inch full HD IPS monitor with thin bezels and 100Hz refresh rate", inventory: 3, supplier_id: 1 },
  { name: "The Rock Blanket", price: "20.00", description: "A very fluffy blanket with Dwayne The Rock Johnson's face on it. Adding more to make this longer", inventory: 2, supplier_id: 1 },
...
Image.create!([
  ...
  { url: "https://m.media-amazon.com/images/I/51OvSvgdx+L._AC_SY300_SX300_.jpg", product_id: 4 },
])
